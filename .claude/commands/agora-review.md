...
```
cd $HOME/Developer/agora && npx tsx scripts/agora-review.ts /tmp/agora-diff-{timestamp}.txt
```
...
1. `$HOME/Developer/agora/scripts/report-template.html`을 읽어서 구조를 참고합니다.
