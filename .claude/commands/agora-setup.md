...
```
cp $HOME/Developer/agora/.env.agora $HOME/Developer/agora/.env.agora.bak 2>/dev/null || true
rm -f $HOME/Developer/agora/.env.agora
```
...
cp $HOME/Developer/agora/.env.agora.bak $HOME/Developer/agora/.env.agora
```
